...
$(function () {
  ...
  $('.md-trigger-2').on('click', function() {
    $('.md-modal-2').addClass('md-show-2');
  });
  
  $('.md-close-2').on('click', function() {
    $('.md-modal-2').removeClass('md-show-2');
  });
...
$(function () {
  ...
  $('.md-trigger-3').on('click', function() {
    $('.md-modal-3').addClass('md-show-3');
  });
  
  $('.md-close-3').on('click', function() {
    $('.md-modal-3').removeClass('md-show-3');
  });
...
$(function () {
  ...
  $('.md-trigger-4').on('click', function() {
    $('.md-modal-4').addClass('md-show-4');
  });
  
  $('.md-close-4').on('click', function() {
    $('.md-modal-4').removeClass('md-show-4');
  });
